 ...
 * @property {number} [embedColor] The color of the giveaway embed when it is running.
 * @property {number} [embedColorEnd] The color of the giveaway embed when it has ended.
 * @property {string} [reaction] The reaction to participate in the giveaway.
 ...
 * @property {number} [embedColor=0xFF4545] The color of the embed when last chance is enabled.
 */
 ...
 * @property {number} [embedColor=0xFFFF00] The color of the embed when the giveaway is paused.
 ...
 * @property {Eris.Constants.Permissions[]} [default.exemptPermissions=[]] Members with any of these permissions won't be able to win a giveaway.
 ...
 * @property {number} [default.embedColor=0x7289DA] The color of the giveaway embeds when they are running.
 * @property {number} [default.embedColorEnd=0x000000] The color of the giveaway embeds when they have ended.
 * @property {string} [default.reaction='🎉'] The reaction to participate in giveaways.
 ...
 * @property {boolean} [useInteractions=false] Whether the bot is using interaction as response.
 ...
 * @property {LastChanceOptions} [newLastChance] The new LastChance options.
 */
 ...
 * @property {string} [reaction] The reaction to participate in the giveaway.
 * @property {boolean} [botsCanWin] If bots can win the giveaway.
 * @property {Eris.Constants.Permissions[]} [exemptPermissions] Members with any of these permissions will not be able to win the giveaway.
